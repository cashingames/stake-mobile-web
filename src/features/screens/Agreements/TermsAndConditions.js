...
const Agreements_module_scss_1 = __importDefault(require("./Agreements.module.scss"));
const TermsAndConditions = () => {
    return (<div className={Agreements_module_scss_1.default.container}>
            <AuthTitle_1.default titleText='Terms & Conditions'/>
            <div>
