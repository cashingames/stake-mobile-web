...
import { challengeEndGame, nextQuestion,  } from '../GameSlice'
import './ChallengeGameInProgress.scss'

function ChallengeGameInProgress() {
...
export default ChallengeGameInProgress;
